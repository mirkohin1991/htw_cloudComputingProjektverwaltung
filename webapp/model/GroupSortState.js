sap.ui.define([
	...
	return BaseObject.extend("hoang.com.CreateProjects.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias hoang.com.CreateProjects.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "ProjectName");
			}
