sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("hoang/com/CreateProjects/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#CreateProjects-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#CreateProjects-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("hoang.com.CreateProjects.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["hoang/com/CreateProjects/localService/mockserver"], function (mockserver) {
