sap.ui.define([
	"hoang/com/CreateProjects/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("ProjectName").length, 1, "The sorting by ProjectName returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by ProjectName and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("ProjectName");
