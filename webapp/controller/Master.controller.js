...
sap.ui.define([
	...
	return BaseController.extend("hoang.com.CreateProjects.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("ProjectName", FilterOperator.Contains, sQuery)];
			} else {
